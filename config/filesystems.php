    ...
    return [
        ...
        */
        ...
        'disks' => [
            ...
            'oss' => [
                'driver'     => 'oss' ,
                'access_id' => env('ALIOSS_ACCESSKEYID'),
                'access_key' => env('ALIOSS_ACCESSKEYSECRET'),
                ...
                'ssl'        => true ,//<true|false> // true to use 'https://' and false to use 'http://'. default is
                // false,
                'isCName'    => false ,//<true|false> // 是否使用自定义域名,true: 则Storage.url()会使用自定义的cdn或域名生成文件url， false:
                // 则使用外部节点生成url
