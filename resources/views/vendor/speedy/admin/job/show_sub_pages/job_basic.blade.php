...
<div class="container" id="product_basic" style="display:block;">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="col-sm-4">
                <div class="input-group">
                    ...
                    <input value="{{isset($job) ? $job->education : ''}}" name="education" type="text"
                           class="form-control" id="education" placeholder="如：博士、硕士等">
                </div>
            </div>
            <div class="col-sm-4">
                <!-- 科研要求 -->
            ...
            <span for="" class="input-group-addon"
                  style="text-align: left;"><span
                        style="color: red;">*</span>科研要求：</span>
                    <input value="{{isset($job->experience) ? $job->experience : ''}}" name="experience"
                           type="text"
                           class="form-control" id="experience" placeholder="如：科研能力、科研成果等">
                </div>
            </div>
            <div class="col-sm-4">
                <!-- 专业要求 -->
            ...
            <span for="" class="input-group-addon"
                  style="text-align: left;"><span
                        style="color: red;">*</span>专业要求：</span>
                    <input value="{{isset($job->type) ? $job->type : ''}}" name="type"
                           type="text"
                           class="form-control" id="type" placeholder="如：生物医药、生物学等">
                </div>
            </div>
        </div>
        <!-- 分隔线 -->
