                        ...
                        <el-main>
                            <el-table
                                ...
                                <el-table-column
                                        label="角色名称">
                                    <template slot-scope="scope">
                                        <el-tag type="success">@{{ scope.row.display_name }}</el-tag>
                                    </template>
                                </el-table-column>
        ...
        let roleIndex = new Vue({
            ...
            methods: {
                ...
                handleEdit(index, row) {
                    this.loading = true;
                    window.location.href = '{{route('admin.role.index')}}' + '/' + row.id + '/edit';
                },
                //删除按钮
                handleDelete(index, row) {
                    this.$confirm('此操作将永久删除该内容, 是否继续?', '提示', {
                        ...
                        this.loading = true;
                        document.getElementById('delete-form').action = '{{ route('admin.role.index') . "/" }}' + row.id;
