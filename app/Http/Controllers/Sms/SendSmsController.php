<?php
    ...
    class SendSmsController extends BaseController
    {
        ...
        public function sendSms(Request $request)
        {
            ...
            $sendList   = $phone;
            $data = $this->randomInt();
            $result = $this->sendTemplateSMS( $sendList , [ $data , '5' ] , $templateId );
            if ( $result == null )
            {
            ...
            else
            {
                ...
                Speedy::getModelInstance( 'sms' )->create( [
                    'verify_code' => $data ,
                    'phone' => $phone ,
                ] );
